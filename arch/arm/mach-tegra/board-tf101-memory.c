...
static const struct tegra_emc_table tf101_emc_tables_elpida_8Gb_300Mhz[] = {
               {
...
static const struct tegra_emc_table tf101_emc_tables_elpida_4Gb_300Mhz[] = {
              {
		.rate = 25000,   /* SDRAM frequency */
		.regs = {
			0x00000002,   /* RC */
...
static const struct tegra_emc_table tf101_emc_tables_Hynix_8Gb_300Mhz[] = {
               {
		.rate = 25000,   /* SDRAM frequency */
		.regs = {
			0x00000002,   /* RC */
...
static const struct tegra_emc_table tf101_emc_tables_Hynix_4Gb_300Mhz[] = {
               {
		.rate = 25000,   /* SDRAM frequency */
		.regs = {
			0x00000002,   /* RC */
...
static const struct tegra_emc_table tf101_emc_tables_elpida_300Mhz[] = {
	{
		.rate = 50000,   /* SDRAM frequency */
		.regs = {
			0x00000003,   /* RC */
...
int tf101_emc_init(void)
{
	...
	switch(strap){
		case 0:
			...
			tegra_init_emc(tf101_emc_tables_elpida_8Gb_300Mhz,
				ARRAY_SIZE(tf101_emc_tables_elpida_8Gb_300Mhz));
			break;
		case 1:
			pr_info("%s: Elpida 4GB memory found\n", __func__);
			tegra_init_emc(tf101_emc_tables_elpida_4Gb_300Mhz,
				ARRAY_SIZE(tf101_emc_tables_elpida_4Gb_300Mhz));
			break;
		case 2:
			pr_info("%s: Hynix 4GB memory found\n", __func__);
			tegra_init_emc(tf101_emc_tables_Hynix_4Gb_300Mhz,
				ARRAY_SIZE(tf101_emc_tables_Hynix_4Gb_300Mhz));
			break;
		case 3:
			pr_info("%s: Hynix 8GB memory found\n", __func__);
			tegra_init_emc(tf101_emc_tables_Hynix_8Gb_300Mhz,
				ARRAY_SIZE(tf101_emc_tables_Hynix_8Gb_300Mhz));
			break;
		default:
			pr_info("%s: memory not found using elpida_300Mhz\n", __func__);
			tegra_init_emc(tf101_emc_tables_elpida_300Mhz,
				ARRAY_SIZE(tf101_emc_tables_elpida_300Mhz));
	}
