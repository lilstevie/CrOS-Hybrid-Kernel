...
void tf101_pinmux_init(void);
int tf101_panel_init(void);
int tf101_kbc_init(void);
int tf101_emc_init(void);

#define TF101_GPIO_ULPI_RESET	TEGRA_GPIO_PG2

#define TF101_GPIO_KEY_POWER	TEGRA_GPIO_PV2
#define TF101_GPIO_KEY_VOLUMEUP	TEGRA_GPIO_PQ5
#define TF101_GPIO_KEY_VOLUMEDOWN	TEGRA_GPIO_PQ4
#define TF101_GPIO_KXTF9_IRQ	TEGRA_GPIO_PS7
#define TF101_GPIO_BT_EXT_WAKE	TEGRA_GPIO_PU1
#define TF101_GPIO_BT_HOST_WAKE	TEGRA_GPIO_PU6
#define TF101_GPIO_VIBRATOR	TEGRA_GPIO_PV5
#define TF101_GPIO_HP_DETECT	TEGRA_GPIO_PW2
#define TF101_GPIO_MIC_EN_INT	TEGRA_GPIO_PX0
#define TF101_GPIO_HP_DET_DOCK	TEGRA_GPIO_PX6
#define TF101_GPIO_AL3000A_IRQ	TEGRA_GPIO_PZ2
#define TF101_GPIO_GPS	TEGRA_GPIO_PZ3

/* TPS6586X gpios */
#define	TF101_TPS6586X_GPIO_BASE	TEGRA_NR_GPIOS
#define AVDD_DSI_CSI_ENB_GPIO	(TF101_TPS6586X_GPIO_BASE + 1) /* gpio2 */
...
#define TF101_WM8903_GPIO_BASE (TCA6416_GPIO_BASE + 16)
#define TF101_GPIO_SPK_AMP (TF101_WM8903_GPIO_BASE + 2)
